...
!(function (e, t) {
    ...
    function b(e, t, r, n) {
        ...
        ((i._getPath = function () {
            var e = this;
            return (
                this.path || (this.composedPath && this.composedPath()) || y(e.target).getParents()
            );
        }),
    ...
    function L(e) {
        return (
            k(Array.prototype.slice.call(arguments, 1), function (t) {
                for (var n in t)
                    void 0 !== t[n] && (r(t[n]) && r(e[n]) ? P(e[n], t[n]) : (e[n] = t[n]));
            }),
            e
        );
    }
                ...
                o[0] && (t.qqBuildinBrowser || t.qqBrowser)
                    ...
                    : o[0] && o[0] < 13
                      ? (t.chrome > 41 || t.firefox > 30 || t.opera > 25 || t.safari > 12) &&
                        (e = !0)
                      : (t.chrome > 41 || t.firefox > 30 || t.opera > 25 || t.safari > 11.3) &&
                        (e = !0));
        } else
            (t.chrome > 38 || t.edge > 13 || t.firefox > 30 || t.opera > 25 || t.safari > 11) &&
                (e = !0);
        return e;
    }
    function de() {
    ...
    function Le(e) {
        ...
        for (var n in r)
            for (var i = r[n], a = 0, o = i.length; a < o; a++) if (i[a].test(t)) return n;
        return '\u672a\u77e5\u641c\u7d22\u5f15\u64ce';
    }
    function Ue(e, t) {
        var r = '';
    ...
    function et(e, t) {
        for (var r in e)
            if (Object.prototype.hasOwnProperty.call(e, r) && !xa.check(r, e[r], t)) return !1;
        return !0;
    }
    function tt(t, n) {
        return r(t)
    ...
    function lt(e) {
        var t = e.properties;
        (ye(e),
            r(t) ? (tt(t), nt(t), at(e), st(t), it(t)) : 'properties' in e && (e.properties = {}),
            ot(e));
    }
    function ut(e, t) {
        var r = t.sensors;
    ...
    function Ct(e) {
        ...
        if (r(Fi.para.is_track_latest))
            for (var n in Fi.para.is_track_latest) t['latest_' + n] = Fi.para.is_track_latest[n];
        ...
        if (
            (Fi.para.heatmap && !r(Fi.para.heatmap) && (Fi.para.heatmap = {}), r(Fi.para.heatmap))
        ) {
    ...
    function Nt(t, n) {
        ...
        if (r(t)) {
            ...
            (o &&
                o !== t &&
                Ne(t.name + ' is conflict with builtin plugin, and sdk uses builtin plugin.'),
                (a = o || t));
        }
        return (
            p(t) &&
    ...
    function It(e, t) {
        var r = kt(e, t);
        r &&
            qa.send({ identities: r, type: 'track_id_unbind', event: '$UnbindID', properties: {} });
    }
    function $t(e, t, r) {
    ...
    function Qt(e, t) {
        return (
            ...
            'number' == typeof e && (e = String(e)),
            !!et({ loginIdKey: e }) &&
                (ha.LOGIN === e ? (Gt(t), !1) : void wt({ id: t, callback: null, name: e }, Mt))
        );
    }
    function Yt(e) {
        var t = $a.getFirstId();
    ...
    function Pr(t) {
        if (!e(t.properties))
            return void je('registerPropertyPlugin arguments error, properties must be function');
    ...
    function Or(e, t, r) {
        if ((t && (e.plugin_name = t), r && e.init)) {
            ...
            e.init = function (i, a) {
                ...
                return (
                    Nr(i, e, t),
                    (i.readyState && i.readyState.state >= 3) || !i.on ? o() : void i.on(r, o)
                );
            };
        }
        return e;
    ...
    function Hr(e, t) {
        ...
        return Co.bridge.is_verify_success
            ? (ko &&
                  ko.call(
                      So,
                      JSON.stringify(Oo.extend({ server_url: Co.para.server_url }, e.data))
                  ),
              Oo.isFunction(r) && r(),
    ...
    function zr(e, t) {
        ...
        if (Io) {
            var n =
                Io &&
                Io.call(jo, JSON.stringify(Do.extend({ server_url: Ao.para.server_url }, e.data)));
            return n
        ...
        return (
            To &&
                To.call(jo, JSON.stringify(Do.extend({ server_url: Ao.para.server_url }, e.data))),
            Do.isFunction(r) && r(),
            t.cancellationToken.cancel(),
            e
        );
    ...
    function sn() {
        if (
            ...
            (_s.registerInterceptor('sendDataStage', { send: { priority: 70, entry: ln } }),
    ...
    function gi(e, t) {
        ...
        dl.isObject(e.config) &&
            ((r = e.config.send_type), (n = dl.optimizeServerUrl(e.config.server_url)));
    ...
    function wi(e, t) {
        ...
        gl.isObject(e.config) &&
            ((r = e.config.send_type), (n = gl.optimizeServerUrl(e.config.server_url)));
    ...
    function Ri() {
        return (
            !!Ki() || Ui() || (Wl.isObject(Vl.para.show_log) && 'warn' === Vl.para.show_log.level)
        );
    }
    function Hi() {
    ...
    Ye.prototype = {
        ...
        send: function () {
            if (
                !(this.sendTimeStamp && t() - this.sendTimeStamp < pa.batch_send.datasend_timeout)
            ) {
    ...
    var Ta = {
        ...
        $a = {
            ...
            getOriginUnionId: function (e) {
                ...
                return (
                    r && n ? ((t.login_id = n), (t.anonymous_id = r)) : (t.anonymous_id = n),
                    t
                );
            },
        ...
        xa = {
            ...
            event: {
                ...
                onComplete: function (t, r, n) {
                    return (
                        t || ('emptyString' === n && (r = 'eventName'), e(Aa[n]) && Aa[n](r)),
                        !0
                    );
                }
            },
            propertyKey: {
                ...
                onComplete: function (t, r, n) {
                    return (
                        t || ('emptyString' === n && (r = 'Property key'), e(Aa[n]) && Aa[n](r)),
                        !0
                    );
                }
            },
            ...
            item_type: {
                ...
                onComplete: function (t, r, n) {
                    return (
                        t || ('emptyString' === n && (r = 'item_type'), e(Aa[n]) && Aa[n](r)),
                        !0
                    );
                }
            },
        ...
        Ha = {
            ...
            getVtrackProps: function (e) {
                ...
                return this.collectAble()
                    ? ('$WebClick' === e.event && (t = this.clickCustomPropMaker(e, this.events)),
                      t)
                    : {};
            },
    ...
    ((qa.check = et),
        (qa.sendItem = function (e) {
            var t = {
                lib: { $lib: 'js', $lib_method: 'code', $lib_version: String(Fi.lib_version) },
                time: 1 * new Date()
            };
    ...
    var Ka = {
        ...
        Va = {
            ...
            getClosestLi: function (t) {
                var r = function (t, r) {
                    for (; t && t !== document && 1 === t.nodeType; t = t.parentNode)
                        if (t.tagName && e(t.tagName.toLowerCase) && t.tagName.toLowerCase() === r)
                            return t;
                    return null;
                };
                return r(t, 'li');
            ...
            initScrollmap: function () {
                if (!r(Fi.para.heatmap) || 'default' !== Fi.para.heatmap.scroll_notice_map)
                    return !1;
                var t = !0;
                Fi.para.scrollmap &&
            ...
            autoTrackSinglePage: function (e, t) {
                function n(e, t) {
                    (Fi.track(
                        '$pageview',
                        P(
                            { $referrer: i, $url: Z(), $url_path: G(), $title: document.title },
                            e,
                            mt()
                        ),
                        t
                ...
                (Fi.para.is_single_page &&
                    w(function () {
                        ...
                        (Fi.track(
                            '$pageview',
                            P(
                                { $referrer: r, $url: Z(), $url_path: G(), $title: document.title },
                                n,
                                e
                            ),
                            t
    ...
    var eo = P({}, la, Ta),
        to = {
            ...
            initPara: function () {
                var e = {
                    is_send:
                        Fi.para.use_app_track_is_send !== !1 && 'only' !== Fi.para.use_app_track,
                    white_list: [],
            ...
            postMessage: function () {
                try {
                    window.parent &&
                        ...
                        window.parent.postMessage(
                            { source: 'sa-web-sdk', type: 'v-is-vtrack', data: { sdkversion: ga } },
                            '*'
                        );
                } catch (e) {
                    je(
                ...
                Lo.registerPage({
                    $is_channel_callback_event: function (e) {
                        if (
                            ...
                            return (
                                !us.eventList.hasEvent(e.event) && (us.eventList.add(e.event), !0)
                            );
                    }
                });
            },
