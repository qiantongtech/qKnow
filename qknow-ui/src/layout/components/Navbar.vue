    ...
    <div class="navbar" ref="navbar">
        ...
        <div class="right-menu">
            <template v-if="appStore.device !== 'mobile'">
                <div class="page-form" v-if="showSelector && knowledgeBaseId">
                    <el-form
                        class="btn-style"
                        :model="route.params"
                        :rules="selectorRules"
        ...
        >
                ...
                <el-row :gutter="20" style="margin-left: 15px; margin-right: -10px">
                    <el-col :span="24">
                        <el-form-item prop="reportExperience" label="工作心得">
                            <template #label>
                                <span
                                    style="color: red; font-weight: 100 !important; font-size: 14px"
                                    >*&nbsp;</span
                                >
                                工作心得
                            </template>
                                ...
                                <el-table-column label="报工项目" min-width="180">
                                    <template v-slot="scope">
                                        <el-select
                                            ...
                                            @change="
                                                projectIdChange(scope.row, scope.row.projectId)
                                            "
                                            filterable
                                            placeholder="请选择项目"
                                        >
            ...
            <template #footer>
                <div class="dialog-footer">
                    ...
                    <el-button class="rounded-button" type="primary" size="mini" @click="submitForm"
                        >提交</el-button
                    >
                    <el-button class="rounded-button" size="mini" @click="cancel">取 消</el-button>
                </div>
            </template>
        </el-dialog>
        <!-- ----------------------------------  报工 ---------------------------- -->
        ...
        >
            <div class="about-content-wrapper">
                <img src="@/assets/system/images/login/logo.png" alt="qData Logo" class="logo" />
...
<script setup>
    ...
    const selectorRules = ref({
        knowledgeBaseId: [{ required: true, message: '请选择知识库或知识图谱', trigger: 'change' }]
    });
