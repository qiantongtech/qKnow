      ...
      <el-aside :style="{ width: `${leftWidth}px` }" class="left-pane">
        <div class="left-tree">
          <div class="head-container">
            <el-input :suffix-icon="Search" v-model="filterText" clearable style="width: 100%; margin-bottom: 20px" placeholder="输入查找名称" />
          </div>
            ...
            <div class="details-dialog" v-if="detailShow">
              <div class="details-title">
                ...
                <div class="title-slot">
                  <el-button size="small" type="danger" icon="Delete" @click="handleDel">删除 </el-button>
                </div>
              </div>
                      ...
                      <el-table stripe height="100px" v-loading="attrLoading" :data="attrData">
                        ...
                        <el-table-column label="操作" class-name="small-padding fixed-width" fixed="right" width="150">
                          <template #default="scope">
                            <el-button link type="primary" icon="Edit" @click="attrUpdate(scope.row)">修改 </el-button>
                            <el-divider direction="vertical" />
                            <el-button link type="danger" icon="Delete" @click="attrDelete(scope.row)">删除 </el-button>
                          </template>
                        </el-table-column>
                      </el-table>
                    </div>
                  ...
                  <el-collapse-item title="关联三元组" name="2">
                    ...
                    <div class="collapse-con">
                      <el-table stripe height="200px" v-loading="tripletLoading" :data="tripletData">
                        ...
                        <el-table-column label="操作" class-name="small-padding fixed-width" fixed="right" width="150">
                          <template #default="scope">
                            <el-button link type="primary" icon="Edit" @click="tripletUpdate(scope.row)">修改 </el-button>
                            <el-divider direction="vertical" />
                            <el-button link type="danger" icon="Delete" @click="tripletDelete(scope.row)">删除 </el-button>
                          </template>
                        </el-table-column>
                      </el-table>
                    </div>
