...
<template>
    <div class="overview-page">
        <div class="overview-top">
            <section class="overview-hero" :style="{ backgroundImage: `url(${bannerImage})` }">
                <div class="hero-copy">
                    <h1>应用中心</h1>
      ...
      <div class="section-content" v-loading="solutionLoading">
        ...
        <section class="overview-section">
            <div class="section-head">
                ...
                <button class="section-more" type="button" @click="goToPage('/kac/horizontal')">
                    查看更多
                    <el-icon><ArrowRight /></el-icon>
                </button>
            </div>
...
<script setup name="Overview">
    ...
    async function getOverviewStats() {
        ...
        if (allApplyRes.status === 'fulfilled') {
            overviewStats.applyTotal = allApplyRes.value.data?.total || overviewStats.applyTotal;
        }
    }
...
<style scoped lang="scss">
    ...
    .stat-grid {
        ...
        background: linear-gradient(180deg, rgba(255, 255, 255, 0.02), rgba(38, 102, 251, 0.04));
    }
