            ...
            <template #default="scope">
                <div>
                    <dict-tag
                        ...
                        :value="getBotInfo(scope.row.botId, 'builtinFlag')"
                    />
                </div>
            </template>
        </el-table-column>
    ...
    >
        ...
        >
            ...
            <el-form-item>
                ...
                <el-button @click="resetQueryBot" @mousedown="(e) => e.preventDefault()">
        ...
        >
            ...
            <el-table-column label="是否内置" align="center" prop="type" width="100">
                <template #default="scope">
                    <div>
                        <dict-tag :options="sys_is_or_not" :value="scope.row.builtinFlag" />
                    </div>
                </template>
            </el-table-column>
        ...
        <template #footer>
            <div class="dialog-footer">
                ...
                <div class="button-wrapper">
                    <el-button size="mini" @click="handleCancel" :disabled="checking"
                        >取 消</el-button
                    >
                    <el-button
                        type="primary"
        ...
        listBot(queryParamsBot.value).then((response) => {
            ...
            nextTick(() => {
                ...
                if (selectedBot.value && botTableRef.value) {
                    const data = botSelectList.value.find(
                        (item) => item.id == selectedBot.value.id
                    );
                    if (data) {
