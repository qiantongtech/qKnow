...
<!--          </el-col>-->
          ...
          <el-col :span="8">
            <div class="infotop-row border-top">
              ...
              <div class="infotop-row-value">{{ parseTime(solutionDetail.createTime, '{y}-{m}-{d} {h}:{i}') }}</div>
            </div>
          </el-col>
          <el-col :span="8">
            <div class="infotop-row border-top">
              <div class="infotop-row-lable">最后更新时间</div>
              <div class="infotop-row-value">{{ parseTime(solutionDetail.updateTime, '{y}-{m}-{d} {h}:{i}') }}</div>
            </div>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="24">
            <div class="infotop-row border-top">
              ...
              <div class="infotop-row-value">
                <el-tooltip :content="solutionDetail.description" placement="top">
    ...
    <div  class="pagecont-bottom">
      <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
        <el-tab-pane label="关联应用" name="1">
          <MyAppList  v-if="activeName === '1'"  :solutionId="solutionDetail.id" :key="activeName" :myAppList="myAppList"></MyAppList>
        </el-tab-pane>
      </el-tabs>
    </div>
