    ...
    >
        ...
        >
            <div class="card-cover">
                <img :src="getImage(item)" alt="解决方案封面" class="card-cover-image" />
            ...
            <div class="card-content">
                <div class="card-title-row">
                    ...
                    <div
                        class="card-date"
                        v-if="props.variant !== 'overview' && getDisplayDate(item.createTime)"
                    >
        ...
        <el-dialog :title="title" v-model="open" width="800px">
            <el-form ref="solutionRef" :model="form" :rules="rules" label-width="80px">
...
<script setup>
    ...
    const props = defineProps({
        ...
        source: {
            type: String,
            default: 'myApp',
            validator: (value) => ['horizontal', 'vertical', 'myApp', 'solution'].includes(value)
        },
        variant: {
            type: String,
            default: 'overview',
