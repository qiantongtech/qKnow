                ...
                <el-row :gutter="15" class="btn-style">
                    <el-col :span="1.5">
                        <el-button
                            ...
                            plain
                            @click="handleAdd"
                            v-hasPermi="['ext:extRelationMapping:relation:add']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                    ...
                    <el-col :span="1.5">
                        <el-button
                            ...
                            :disabled="single"
                            @click="handleUpdate"
                            v-hasPermi="['ext:extRelationMapping:relation:edit']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                    ...
                    <el-col :span="1.5">
                        <el-button
                            ...
                            :disabled="multiple"
                            @click="handleDelete"
                            v-hasPermi="['ext:extRelationMapping:relation:remove']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                    ...
                    <el-col :span="1.5">
                        <el-button
                            ...
                            plain
                            @click="handleImport"
                            v-hasPermi="['ext:extRelationMapping:relation:export']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                ...
                >
                    <template #default="scope">
                        ...
                        <el-button
                            ...
                            type="primary"
                            icon="view"
                            @click="routeTo('/ext/extRelationMapping/relationDetail', scope.row)"
                            v-hasPermi="['ext:extRelationMapping:relation:edit']"
                            >复杂详情</el-button
                        >
                    </template>
...
<script setup name="Relation">
    import {
        ...
        addRelation,
        updateRelation
    } from '@/api/ext/extRelationMapping/relation';
    ...
    function handleDelete(row) {
        ...
        proxy.$modal
            .confirm('是否确认删除关系映射编号为"' + _ids + '"的数据项？')
            .then(function () {
