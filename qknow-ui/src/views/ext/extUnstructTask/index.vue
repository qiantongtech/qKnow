...
<script setup name="UnstructTask">
    ...
    const taskDescriptionMap = {
        ...
        人体结构学抽取: '识别人体器官、组织结构、解剖部位及其层级关系，支撑医学知识图谱构建。',
        疾病治疗方案抽取: '围绕具体疾病抽取用药方案、手术方式、护理措施和疗效评估等治疗方案信息。',
        药物机械知识抽取: '抽取药物名称、适应症、用法用量以及医疗器械用途、操作规范等知识内容。',
        治疗方法综合抽取:
            '汇总药物治疗、手术治疗、物理治疗和康复治疗等方法，抽取适用场景与注意事项。',
        疾病识别综合抽取: '从多格式文本中识别疾病实体、临床表现、检查结果与诊断结论等综合信息。',
        医疗人力资源组织抽取: '抽取医疗机构人员、岗位职责、组织架构和科室协作关系等管理类知识。',
        医学健康综合抽取: '面向医学健康资料抽取疾病、药物、检查、干预和健康管理等综合知识要素。',
        综合器械应用抽取: '识别医疗器械名称、应用场景、操作流程、维护要求及安全注意事项。',
        医学机械抽取任务: '抽取医学设备和医疗机械的名称、功能、适用科室、使用规范及维护信息。',
        医学器械抽取任务: '抽取医学设备和医疗器械的名称、功能、适用科室、使用规范及维护信息。',
        药物器械知识抽取: '抽取药物名称、适应症、用法用量以及医疗器械用途、操作规范等知识内容。',
        医学机构抽取任务: '抽取医院、科室、医疗机构类型、等级、地址及服务能力等机构相关信息。'
    };
