        ...
        <div class="pagecont-bottom">
                ...
                <el-row :gutter="15" class="btn-style">
                    <el-col :span="1.5">
                        <el-button
                            ...
                            plain
                            @click="handleAdd"
                            v-hasPermi="['ext:extSchemaRelation:relation:add']"
                            @mousedown="(e) => e.preventDefault()"
                        >
            ...
            >
                ...
                >
                    <template #default="scope">
                        {{
                            scope.row.inverseFlag === 1
                                ? '是'
                                : scope.row.inverseFlag === 0
                                  ? '否'
                                  : '-'
                        }}
                    </template>
                ...
                >
                    <template #default="scope">
                        <el-button
                            ...
                            v-hasPermi="['ext:extSchemaRelation:relation:edit']"
                            >修改</el-button
                        >
                        <el-button
                            link
                            ...
                            v-hasPermi="['ext:extSchemaRelation:relation:remove']"
                            >删除</el-button
                        >
...
<script setup name="Relation">
    import {
        ...
        addRelation,
        updateRelation
    } from '@/api/ext/extSchemaRelation/relation';
