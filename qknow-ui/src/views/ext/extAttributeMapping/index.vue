                ...
                <el-row :gutter="15" class="btn-style">
                    <el-col :span="1.5">
                        <el-button
                            ...
                            plain
                            @click="handleAdd"
                            v-hasPermi="['ext:extAttributeMapping:mapping:add']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                    ...
                    <el-col :span="1.5">
                        <el-button
                            ...
                            :disabled="single"
                            @click="handleUpdate"
                            v-hasPermi="['ext:extAttributeMapping:mapping:edit']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                    ...
                    <el-col :span="1.5">
                        <el-button
                            ...
                            :disabled="multiple"
                            @click="handleDelete"
                            v-hasPermi="['ext:extAttributeMapping:mapping:remove']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                    ...
                    <el-col :span="1.5">
                        <el-button
                            ...
                            plain
                            @click="handleImport"
                            v-hasPermi="['ext:extAttributeMapping:mapping:export']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                ...
                >
                    <template #default="scope">
                        ...
                        <el-button
                            ...
                            type="primary"
                            icon="view"
                            @click="routeTo('/ext/extAttributeMapping/mappingDetail', scope.row)"
                            v-hasPermi="['ext:extAttributeMapping:mapping:edit']"
                            >复杂详情</el-button
                        >
                    </template>
...
<script setup name="Mapping">
    import {
        ...
        addMapping,
        updateMapping
    } from '@/api/ext/extAttributeMapping/mapping';
    ...
    function handleDelete(row) {
        ...
        proxy.$modal
            .confirm('是否确认删除属性映射编号为"' + _ids + '"的数据项？')
            .then(function () {
