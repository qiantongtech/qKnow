                ...
                <el-row :gutter="15" class="btn-style">
                    <el-col :span="1.5">
                        <el-button
                            ...
                            plain
                            @click="handleAdd"
                            v-hasPermi="['ext:extSchemaMapping:schema:add']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                    ...
                    <el-col :span="1.5">
                        <el-button
                            ...
                            :disabled="single"
                            @click="handleUpdate"
                            v-hasPermi="['ext:extSchemaMapping:schema:edit']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                    ...
                    <el-col :span="1.5">
                        <el-button
                            ...
                            :disabled="multiple"
                            @click="handleDelete"
                            v-hasPermi="['ext:extSchemaMapping:schema:remove']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                    ...
                    <el-col :span="1.5">
                        <el-button
                            ...
                            plain
                            @click="handleImport"
                            v-hasPermi="['ext:extSchemaMapping:schema:export']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                ...
                >
                    <template #default="scope">
                        ...
                        <el-button
                            ...
                            type="primary"
                            icon="view"
                            @click="routeTo('/ext/extSchemaMapping/schemaDetail', scope.row)"
                            v-hasPermi="['ext:extSchemaMapping:schema:edit']"
                            >复杂详情</el-button
                        >
                    </template>
...
<script setup name="Schema">
    import {
        ...
        addSchema,
        updateSchema
    } from '@/api/ext/extSchemaMapping/schema';
    ...
    function handleDelete(row) {
        ...
        proxy.$modal
            .confirm('是否确认删除概念映射编号为"' + _ids + '"的数据项？')
            .then(function () {
