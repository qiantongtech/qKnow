                ...
                <el-row :gutter="15" class="btn-style">
                    <el-col :span="1.5">
                        <el-button
                            ...
                            plain
                            @click="handleAdd"
                            v-hasPermi="['ext:extDatasource:datasource:add']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                    ...
                    <el-col :span="1.5">
                        <el-button
                            ...
                            :disabled="single"
                            @click="handleUpdate"
                            v-hasPermi="['ext:extDatasource:datasource:edit']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                    ...
                    <el-col :span="1.5">
                        <el-button
                            ...
                            :disabled="multiple"
                            @click="handleDelete"
                            v-hasPermi="['ext:extDatasource:datasource:remove']"
                            @mousedown="(e) => e.preventDefault()"
                        >
            ...
            >
                ...
                >
                    <template #default="scope">
                        <!--           {{ scope.row.status || '-' }}-->
                        <dict-tag
                            :options="ext_data_source_connection_status"
...
<script setup name="Datasource">
    import {
        ...
        addDatasource,
        updateDatasource
    } from '@/api/ext/extDatasource/datasource';
    import { getToken } from '@/utils/auth.js';

    const { proxy } = getCurrentInstance();
    const { ext_data_source_type, ext_data_source_connection_status } = proxy.useDict(
        'ext_data_source_type',
        'ext_data_source_connection_status'
    );
