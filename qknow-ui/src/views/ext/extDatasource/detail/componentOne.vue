        ...
        <el-row :gutter="15" class="btn-style">
            <el-col :span="1.5">
                <el-button
                    ...
                    plain
                    @click="handleAdd"
                    v-hasPermi="['extDatasource:datasource:add']"
            ...
            <el-col :span="1.5">
                <el-button
                    ...
                    plain
                    @click="handleExport"
                    v-hasPermi="['extDatasource:datasource:export']"
                    @mousedown="(e) => e.preventDefault()"
                >
        ...
        >
            <template #default="scope">
                <el-button
                    ...
                    v-hasPermi="['extDatasource:datasource:edit']"
                    >修改</el-button
                >
                <el-button
                    link
                    ...
                    v-hasPermi="['extDatasource:datasource:remove']"
                    >删除</el-button
                >
                <el-button
                    link
