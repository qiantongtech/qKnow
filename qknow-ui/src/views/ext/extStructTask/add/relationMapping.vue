            ...
            >
                ...
                <el-row :gutter="20">
                    <el-col :span="10">
                        ...
                        >
                            <el-select
                                @change="handleTableChange(index, 'source', data.source.tableName)"
                ...
                <el-row :gutter="20">
                    <el-col :span="10">
                        ...
                        >
                            <el-select
                                @change="handleTableChange(index, 'target', data.target.tableName)"
...
<script setup>
    ...
    const isDuplicateRelation = (item1, item2) => {
        ...
        if (item1.type === 2 && item2.type === 2) {
            if (item1.relationMappingMiddle.length !== item2.relationMappingMiddle.length) {
                return false;
            }

            const middleTablesMatch = item1.relationMappingMiddle.every((middleTable, idx) => {
    ...
    const isCompleteRelation = (item) => {
        ...
        if (item.type === 2) {
            if (!item.relationMappingMiddle || item.relationMappingMiddle.length === 0) {
                return false;
            }
