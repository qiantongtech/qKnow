<template>
    <!-- 导入表 -->
    <el-dialog title="导入表" v-model="visible" width="1000px" top="5vh" :append-to="$refs['app-container']"
               draggable destroy-on-close @close="handleClose">
...
<script setup>
    ...
    function handleImportTable() {
        ...
        dataTableList = dbTableList.value.filter(e => tables.value.includes(e.tableName));
