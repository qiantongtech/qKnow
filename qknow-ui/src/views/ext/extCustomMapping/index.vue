    ...
    <div class="pagecont-top" v-show="showSearch">
     <el-form class="btn-style" :model="queryParams" ref="queryRef" :inline="true" label-width="75px" v-show="showSearch" @submit.prevent>
      ...
      <el-form-item label="sql语句" prop="sqlStatement">
        <el-input
            class="el-form-input-width"
            v-model="queryParams.sqlStatement"
    ...
    <div  class="pagecont-bottom">
     <div class="justify-between mb15">
       <el-row :gutter="15" class="btn-style">
         <el-col :span="1.5">
           <el-button type="primary" plain @click="handleAdd" v-hasPermi="['ext:extCustomMapping:mapping:add']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-xinzeng mr5"></i>新增
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="primary" plain :disabled="single" @click="handleUpdate" v-hasPermi="['ext:extCustomMapping:mapping:edit']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-xiugai--copy mr5"></i>修改
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="danger" plain :disabled="multiple" @click="handleDelete" v-hasPermi="['ext:extCustomMapping:mapping:remove']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-shanchu-huise mr5"></i>删除
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="info" plain  @click="handleImport" v-hasPermi="['ext:extCustomMapping:mapping:export']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-upload-cloud-line mr5"></i>导入
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button type="warning" plain @click="handleExport" v-hasPermi="['ext:extCustomMapping:mapping:export']"
                      @mousedown="(e) => e.preventDefault()">
     ...
     <el-table stripe height="590px" v-loading="loading" :data="mappingList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
       ...
       <el-table-column v-if="getColumnVisibility(7)" label="sql语句" align="center" prop="sqlStatement">
         <template #default="scope">
           {{ scope.row.sqlStatement || '-' }}
         </template>
       </el-table-column>
       ...
       <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="240">
         <template #default="scope">
           <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                      v-hasPermi="['ext:extCustomMapping:mapping:edit']">修改</el-button>
           <el-button link type="danger" icon="Delete" @click="handleDelete(scope.row)"
                      v-hasPermi="['ext:extCustomMapping:mapping:remove']">删除</el-button>
           <el-button link type="primary" icon="view" @click="handleDetail(scope.row)"
                      v-hasPermi="['ext:extCustomMapping:mapping:edit']">详情</el-button>
           <el-button link type="primary" icon="view" @click="routeTo('/ext/extCustomMapping/mappingDetail',scope.row)"
                      v-hasPermi="['ext:extCustomMapping:mapping:edit']">复杂详情</el-button>
         </template>
       </el-table-column>
    ...
    <el-dialog :title="title" v-model="open" width="800px" :append-to="$refs['app-container']" draggable>
      ...
      <el-form ref="mappingRef" :model="form" :rules="rules" label-width="80px" @submit.prevent>
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="sql语句" prop="sqlStatement">
                <el-input v-model="form.sqlStatement" placeholder="请输入sql语句" />
              </el-form-item>
            </el-col>
            <el-col :span="24">
        ...
        <template #tip>
          <div class="el-upload__tip text-center">
            <div class="el-upload__tip">
              <el-checkbox v-model="upload.updateSupport" />是否更新已经存在的自定义映射数据
            </div>
...
<script setup name="Mapping">
  import { listMapping, getMapping, delMapping, addMapping, updateMapping } from "@/api/ext/extCustomMapping/mapping";
  ...
  const columns = ref([
            ...
            { key: 7, label: "sql语句", visible: true },
  ...
  function handleDelete(row) {
    ...
    proxy.$modal.confirm('是否确认删除自定义映射编号为"' + _ids + '"的数据项？').then(function() {
