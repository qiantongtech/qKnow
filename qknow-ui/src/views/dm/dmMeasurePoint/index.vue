        ...
        <div class="pagecont-bottom">
                ...
                <el-row :gutter="15" class="btn-style">
                    <el-col :span="1.5">
                        <el-button
                            ...
                            plain
                            @click="handleAdd"
                            v-hasPermi="['dm:dmMeasurePoint:point:add']"
                            @mousedown="(e) => e.preventDefault()"
                        >
            ...
            >
                ...
                >
                    <template #default="scope">
                        {{
                            scope.row.realtimeFlag === 0
                                ? '否'
                                : scope.row.realtimeFlag === 1
                                  ? '是'
                                  : '-'
                        }}
                    </template>
                ...
                >
                    <template #default="scope">
                        {{
                            scope.row.failureFlag === 0
                                ? '否'
                                : scope.row.failureFlag === 1
                                  ? '是'
                                  : '-'
                        }}
                    </template>
                ...
                >
                    <template #default="scope">
                        <el-button
                            ...
                            v-hasPermi="['dm:dmMeasurePoint:point:edit']"
                            >修改</el-button
                        >
                        <el-button
                            link
                            ...
                            v-hasPermi="['dm:dmMeasurePoint:point:remove']"
                            >删除</el-button
                        >
                        <el-button
                            link
...
<script setup name="Point">
    import {
        ...
        addPoint,
        updatePoint
    } from '@/api/dm/dmMeasurePoint/point';
    ...
    function handleDelete(row) {
        ...
        proxy.$modal
            .confirm('是否确认删除物联网测点编号为"' + _ids + '"的数据项？')
            .then(function () {
