                ...
                <el-row :gutter="15" class="btn-style">
                    <el-col :span="1.5">
                        <el-button
                            ...
                            plain
                            @click="handleAdd"
                            v-hasPermi="['dm:dmAlarmConfig:config:add']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                ...
                >
                    <template #default="scope">
                        <el-button
                            ...
                            v-hasPermi="['dm:dmAlarmConfig:config:edit']"
                            >修改</el-button
                        >
                        <el-button
                            link
                            ...
                            v-hasPermi="['dm:dmAlarmConfig:config:remove']"
                            >删除</el-button
                        >
                        <el-button
                            link
...
<script setup name="Config">
    import {
        ...
        addConfig,
        updateConfig
    } from '@/api/dm/dmAlarmConfig/config';
    ...
    function handleDelete(row) {
        ...
        proxy.$modal
            .confirm('是否确认删除告警配置编号为"' + _ids + '"的数据项？')
            .then(function () {
