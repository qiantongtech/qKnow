                ...
                <el-row :gutter="15" class="btn-style">
                    <el-col :span="1.5">
                        <el-button
                            ...
                            plain
                            @click="handleAdd"
                            v-hasPermi="['dm:dmExpertAdvice:advice:add']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                ...
                >
                    <template #default="scope">
                        <span v-if="scope.row.operateCond">
                            {{
                                scope.row.operateCond
                                    .split(',')
                                    .map((item) => operateCondLabels[item])
                                    .join(', ')
                            }}
                        </span>
                        <span v-else>-</span>
                ...
                >
                    <template #default="scope">
                        <el-button
                            ...
                            v-hasPermi="['dm:dmExpertAdvice:advice:edit']"
                            >修改</el-button
                        >
                        <el-button
                            link
                            ...
                            v-hasPermi="['dm:dmExpertAdvice:advice:remove']"
                            >删除</el-button
                        >
                        <el-button
                            link
...
<script setup name="Advice">
    import {
        ...
        addAdvice,
        updateAdvice
    } from '@/api/dm/dmExpertAdvice/advice';
    ...
    function handleDelete(row) {
        ...
        proxy.$modal
            .confirm('是否确认删除专家经验编号为"' + _ids + '"的数据项？')
            .then(function () {
