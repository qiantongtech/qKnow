                ...
                <el-row :gutter="20">
                    <el-col :span="24">
                        <el-form-item label="应用图标" prop="icon">
                            <div class="xgtpcont">
                                <ImageUpload class="sctplist" v-model="form.icon"> </ImageUpload>
                            </div>
                        </el-form-item>
                    </el-col>
                </el-row>
...
<script setup name="Client">
    import {
        ...
        addClient,
        updateClient
    } from '@/api/system/auth/client.js';
    ...
    const data = reactive({
        ...
        rules: {
            secretKey: [{ required: true, message: '应用秘钥不能为空', trigger: 'blur' }],
            name: [{ required: true, message: '应用名称不能为空', trigger: 'blur' }],
            type: [{ required: true, message: '应用类型', trigger: 'change' }],
            redirectUrl: [{ required: true, message: '允许授权的url不能为空', trigger: 'blur' }],
            publicFlag: [{ required: true, message: '是否公开不能为空', trigger: 'blur' }],
            validFlag: [{ required: true, message: '是否有效', trigger: 'blur' }]
        }
    });
