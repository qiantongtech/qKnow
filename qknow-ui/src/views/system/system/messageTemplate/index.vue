...
<script setup name="MessageTemplate">
    ...
    const data = reactive({
        ...
        rules: {
            ...
            content: [{ required: true, message: '消息模板内容不能为空', trigger: 'blur' }],
            category: [{ required: true, message: '消息类别不能为空', trigger: 'blur' }],
            msgLevel: [{ required: true, message: '消息等级不能为空', trigger: 'blur' }]
        }
    });
