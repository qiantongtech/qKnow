        ...
        <div class="pagecont-bottom">
            ...
            >
                ...
                <el-table-column label="有效期" align="center" prop="validTime">
                    <template #default="scope"> {{ scope.row.validTime }} 年 </template>
                </el-table-column>
                <el-table-column
                    label="生效时间"
                    align="center"
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    subjectId: [{ required: true, message: '主体id不能为空', trigger: 'change' }],
                    subjectName: [
                        { required: true, message: '主体名称不能为空', trigger: 'change' }
                    ],
                    issuer: [{ required: true, message: '颁发者不能为空', trigger: 'blur' }],
                    possessor: [{ required: true, message: '所有者不能为空', trigger: 'blur' }],
