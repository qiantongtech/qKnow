    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    cn: [{ required: true, message: '通用名称不能为空', trigger: 'blur' }],
                    ou: [{ required: true, message: '组织单位名称不能为空', trigger: 'blur' }],
                    o: [{ required: true, message: '组织名称不能为空', trigger: 'blur' }],
                    l: [{ required: true, message: '城市名称不能为空', trigger: 'blur' }],
                    st: [{ required: true, message: '省名称不能为空', trigger: 'blur' }],
                    c: [{ required: true, message: '国家不能为空', trigger: 'blur' }]
                }
            };
        },
        created() {
        ...
        methods: {
            ...
            handleDelete(row) {
                ...
                this.$modal
                    .confirm('是否确认删除主体管理编号为"' + ids + '"的数据项？')
                    .then(function () {
