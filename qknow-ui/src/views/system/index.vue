...
const license = {
  ...
  text: {
    intro: [
      " qKnow 依据 Apache License 2.0 提供，并受以下针对  qKnow 的特定附加条件约束：",
      "在本协议中，“ qKnow” 是指整个软件项目，包括但不限于其前端、后端、API 及相关文档的全部或部分内容。",
      "在本协议中，“制作方” 是指江苏千桐科技有限公司。",
    ],
    terms: [
      {
        title:
          "您可以将  qKnow 用于商业目的，但不得移除、隐藏或修改  qKnow 中显示的  qKnow 标识、版权声明、许可声明或归属信息。",
        desc: [
          "如果您希望移除、隐藏、遮蔽、替换或修改上述标识、版权声明、许可声明或归属信息，包括但不限于白标使用、OEM 分发、品牌重塑或将  qKnow 作为其他产品展示，您必须向制作方另行申请商业许可。",
        ],
      },
      {
        title: "作为贡献者，您应当同意：",
...
const LICENSE_CACHE_KEY = " qKnow_license_acknowledged";
 ...
 */
function toPolicy() {
  window.open("https://community.qknow.ai/business/policy.html");
}
