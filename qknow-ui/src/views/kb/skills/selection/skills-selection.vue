...
<template>
  ...
  >
    ...
    >
      ...
      <el-table-column label="编码" align="center" prop="id" width="55"/>
...
<script setup name="SkillsSelection">
import { listSkills } from "@/api/kb/skills/skills";
...
function getList() {
  loading.value = true;
  listSkills(proxy.addDateRange(queryParams.value, dateRange.value)).then(
      async (response) => {
