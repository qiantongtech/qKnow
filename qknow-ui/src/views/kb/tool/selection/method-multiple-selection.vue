...
<template>
  ...
  >
    ...
    >
      ...
      <el-table-column label="标签" align="left" prop="tags" min-width="120" width="250">
        <template #default="scope">
...
import {listTool} from '@/api/kb/tool/tool';
import {ref} from 'vue';
...
function getList() {
  ...
  listTool(proxy.addDateRange(queryParams.value, dateRange.value)).then(
      async (response) => {
