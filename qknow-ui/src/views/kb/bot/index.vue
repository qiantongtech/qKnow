    ...
    <div class="app-container" ref="app-container">
        ...
        <div class="pagecont-bottom">
            ...
            >
                ...
                <el-table-column
                    label="节点数"
                    v-if="getColumnVisibility(9) && (botType === 1 || botType === 0)"
                    align="center"
                    prop="createBy"
                    width="80"
                >
                ...
                <el-table-column
                    label="工具数"
                    v-if="getColumnVisibility(9) && botType === 2"
                    align="center"
                    prop="createBy"
                    width="80"
                >
        ...
        >
            ...
            <el-form ref="botRef" :model="form" :rules="rules" label-width="80px" @submit.prevent>
                <el-row :gutter="20">
                    <el-col :span="24">
                        <el-form-item label="名称" prop="name">
