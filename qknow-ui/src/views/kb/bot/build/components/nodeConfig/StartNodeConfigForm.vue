        ...
        <div class="start-config-section">
            <div class="start-config-section-header">
                <div>
                    ...
                    <div class="start-config-section-tip">配置进入工作流前可用的输入变量。</div>
                </div>
            ...
            >
                ...
                <el-table-column label="操作" width="110" align="center">
                    <template #default="{ row }">
                        <div v-if="row.readonly" class="start-field-table-readonly">默认变量</div>
                        <div v-else class="start-field-table-actions">
                            <el-button link type="primary" @click.stop="$emit('editField', row)">
                                修改
                            </el-button>
                            <el-button link type="danger" @click.stop="handleRemoveField(row.id)">
                                删除
                            </el-button>
                        </div>
                    </template>
