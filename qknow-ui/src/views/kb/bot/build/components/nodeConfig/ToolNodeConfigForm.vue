...
<template>
    <div class="tool-config-panel">
        <div class="tool-config-section">
            <div class="tool-config-section-title node-config-section-title">工具信息</div>
        ...
        <div class="tool-config-section">
            <div class="tool-config-section-title node-config-section-title">节点描述</div>
            <el-input
        ...
        <div class="tool-config-section">
            <div class="tool-config-section-header">
                <div>
                    <div class="tool-config-section-title node-config-section-title">输出变量</div>
            ...
            >
                ...
                <el-table-column label="显示名称" min-width="140" align="center">
                    <template #default="{ row }">
                        <el-input
                            ...
                            class="tool-output-field"
                            placeholder="显示名称"
                            @update:model-value="updateOutput(row.id, { variableLabel: $event })"
                        />
                    </template>
                </el-table-column>
                ...
                <el-table-column label="操作" width="88" align="center">
                    <template #default="{ row }">
                        <el-button link type="danger" @click.stop="handleRemoveOutput(row.id)">
                            删除
                        </el-button>
                    </template>
                </el-table-column>
...
<script setup>
    ...
    const emit = defineEmits(['updateField', 'addOutput', 'updateOutput', 'removeOutput']);
