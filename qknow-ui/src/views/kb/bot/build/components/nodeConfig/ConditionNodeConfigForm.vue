...
<template>
    <div class="condition-editor">
        ...
        <div v-for="(caseItem, index) in cases" :key="caseItem.id" class="condition-case-card">
            ...
            <el-input
                ...
                @update:model-value="$emit('updateCase', { id: caseItem.id, expression: $event })"
            />
            <div v-else class="condition-case-placeholder">未命中以上条件时，进入该兜底分支。</div>
        </div>
    </div>
</template>
