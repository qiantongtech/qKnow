        ...
        <div v-for="(item, index) in data" :key="index" class="card">
            ...
            <div class="card-bottom">
                ...
                >
                    ...
                    <template #content>
                        <div style="width: 450px; font-size: 14px; color: #333; padding: 7px">
                            {{ item.description }}
                        </div>
                    </template>
                ...
                <div class="card-bottom-button">
                    ...
                    >
                        ...
                        <div class="card-bottom-name">密钥设置</div>
                    </el-button>
...
<script setup>
    ...
    const { ai_apikey_status, ai_model_tag } = proxy.useDict('ai_apikey_status', 'ai_model_tag');
