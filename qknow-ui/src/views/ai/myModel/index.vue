...
<script setup name="Key">
    import { listByPlatform, removeKey, submitBatch, myModelPage } from '@/api/ai/modelMarket/key';
    ...
    function handleUpdate(row) {
        ...
        if (row.platform === 'Ollama') {
            ...
            rules.url = [{ required: true, message: 'API地址不能为空', trigger: 'blur' }];
...
<style scoped lang="scss">
    ...
    :deep(.no-change-link) {
        ...
        &:active,
        &:visited {
            color: var(--el-color-primary) !important; // 悬浮/点击/已访问 都保持蓝色不变
