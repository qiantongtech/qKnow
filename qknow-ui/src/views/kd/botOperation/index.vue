...
<script setup name="BotOperation">
    ...
    const showTypeChart = computed(() => dashboardData.value.mode !== 'placeholder');
    ...
    watch(
        ...
        () => {
            const maxPage = Math.max(1, Math.ceil(healthList.value.length / healthPageSize.value));
        ...
        return {
            ...
            trend: {
                datasets: {
                    ...
                    '30d': {
                        labels: ['03-01', '03-05', '03-10', '03-15', '03-20', '03-25', '03-31'],
