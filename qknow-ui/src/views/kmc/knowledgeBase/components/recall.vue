        ...
        <div class="container">
            ...
            >
                <template #header="{ close, titleId, titleClass }">
                    <span role="heading" aria-level="2" class="el-dialog__title"> 检索设置 </span>
                </template>
                <!-- <div class="app-container">
                    ...
                    <div class="section-block section-block-rule">
                        ...
                        >
                            ...
                            >
                                ...
                                <el-form-item class="form-item-inline topk-rule-posi-" prop="topK">
        ...
        topK: [
            {
                ...
                validator: (rule, value, callback) => {
                    ...
                    if (currentTopK === null || currentTopK === undefined || currentTopK === '') {
            ...
            },
            {
                validator: (rule, value, callback) => {
                    ...
                    if (currentScoreThreshold < 0 || currentScoreThreshold > 1) {
                        ...
                        const decimalLen = (currentScoreThreshold.toString().split('.')[1] || '')
                            .length;
                        if (decimalLen > 1) {
            ...
            },
            {
                validator: (rule, value, callback) => {
                    ...
                    if (currentWeight < 0 || currentWeight > 1) {
                        ...
                        // 校验最多1位小数
                        const decimalLen = (currentWeight.toString().split('.')[1] || '').length;
                        if (decimalLen > 1) {
    ...
    const submitForm = () => {
        proxy.$refs['knowledgeBaseRef'].validate((valid) => {
            if (valid) {
                if (knowledgeBase.value.indexingTechnique !== 'economy') {
                    if (knowledgeBase.value.searchMethod === 'semantic_search') {
                        knowledgeBase.value.rerankingEnable = vectorData.value.rerankingEnable;
                        ...
                        knowledgeBase.value.rerankingEnable = fullTextData.value.rerankingEnable;
                        knowledgeBase.value.rerankingModelName =
                        ...
                        knowledgeBase.value.scoreThreshold = fullTextData.value.scoreThreshold;
                    } else if (knowledgeBase.value.searchMethod === 'hybrid_search') {
                        if (mixData.value.rerankingMode === 'weighted_score') {
                        ...
                        knowledgeBase.value.rerankingModelName = mixData.value.rerankingModelName;
