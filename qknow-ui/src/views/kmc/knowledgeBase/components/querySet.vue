        ...
        >
            ...
            <div class="section-block">
                ...
                <div class="search-method-group">
                    <!-- 向量检索 -->
                    <div class="search-method-row" v-if="form.indexingTechnique !== 'economy'">
                        <div
                        ...
                        <div v-show="form.indexingTechnique !== 'economy'" class="search-desc">
            ...
            <div class="section-block" v-if="form.indexingTechnique !== 'economy'">
                ...
                >
                    <!-- 向量检索规则 -->
                    <div v-show="form.searchMethod === 'semantic_search'" class="query-rule">
                    ...
                    <!-- 全文检索规则 -->
                    <div v-show="form.searchMethod === 'full_text_search'" class="query-rule">
                        <el-form-item class="form-item-inline">
                            <div class="option-label">Rerank模型启用状态:</div>
                ...
                <div class="dialog-footer">
                    <el-button type="default" size="small" plain @click="back"> 取消 </el-button>
...
<script setup>
    ...
    import { reactive, ref, watch, watchEffect, nextTick, getCurrentInstance } from 'vue';
            ...
            weightAllocation: [
                {
                    ...
                    validator: (rule, value, callback) => {
                        ...
                        if (
                            ...
                            if (!mixData.value.keywordWeight && mixData.value.keywordWeight !== 0) {
                    ...
                    Object.assign(mixData.value, {
                        ...
                        weightedScoreThresholdEnabled:
                            form.value.rerankingMode === 'weighted_score'
                                ...
                                : null,
                        rerankTopK:
                            form.value.rerankingMode === 'reranking_model' ? form.value.topK : 1,
        ...
        if (form.value.indexingTechnique !== 'economy') {
            ...
            if (form.value.searchMethod === 'semantic_search') {
                ...
                if (mixData.value.rerankingMode === 'weighted_score') {
                    ...
                    mixData.value.scoreThresholdEnabled = mixData.value.rerankScoreThresholdEnabled;
                }
    ...
    function handleDataScope(id) {
        ...
        getRole(id).then((response) => {
            ...
            const selectedRoleIds =
                id === 0 ? [] : response.data.knowledgeRoleList.map((item) => item.roleId);
