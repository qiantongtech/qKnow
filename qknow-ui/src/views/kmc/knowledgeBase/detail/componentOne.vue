...
<template>
        ...
        <el-row :gutter="15" class="btn-style">
            <el-col :span="1.5">
                <el-button
                    ...
                    plain
                    @click="handleAdd"
                    v-hasPermi="['knowledgeBase:knowledgeBase:add']"
            ...
            <el-col :span="1.5">
                <el-button
                    ...
                    plain
                    @click="handleExport"
                    v-hasPermi="['knowledgeBase:knowledgeBase:export']"
                    @mousedown="(e) => e.preventDefault()"
                >
    ...
    >
        ...
        <el-table-column
            ...
            label="Embedding 模型供应商"
            align="center"
            prop="embeddingModelProvider"
        >
            <template #default="scope">
        ...
        >
            <template #default="scope">
                <el-button
                    ...
                    v-hasPermi="['knowledgeBase:knowledgeBase:edit']"
                    >修改</el-button
                >
                <el-button
                    link
                    ...
                    v-hasPermi="['knowledgeBase:knowledgeBase:remove']"
                    >删除</el-button
                >
                <el-button
                    link
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="12">
                    <el-form-item label="Embedding 模型供应商" prop="embeddingModelProvider">
                        <el-input
                            v-model="form.embeddingModelProvider"
            ...
            <el-row :gutter="20">
                <el-col :span="12">
                    <el-form-item label="Rerank 模型的提供商" prop="rerankingProviderName">
                        <el-input
                            v-model="form.rerankingProviderName"
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="12">
                    <el-form-item label="是否开启召回分数限制" prop="scoreThresholdEnabled">
                        <el-input
                            v-model="form.scoreThresholdEnabled"
