        ...
        <el-row :gutter="15" class="btn-style">
            <el-col :span="1.5">
                <el-button
                    ...
                    plain
                    @click="handleAdd"
                    v-hasPermi="['knowledgeSegment:knowledgeSegment:add']"
            ...
            <el-col :span="1.5">
                <el-button
                    ...
                    plain
                    @click="handleExport"
                    v-hasPermi="['knowledgeSegment:knowledgeSegment:export']"
                    @mousedown="(e) => e.preventDefault()"
                >
        ...
        >
            <template #default="scope">
                <el-button
                    ...
                    v-hasPermi="['knowledgeSegment:knowledgeSegment:edit']"
                    >修改</el-button
                >
                <el-button
                    link
                    ...
                    v-hasPermi="['knowledgeSegment:knowledgeSegment:remove']"
                    >删除</el-button
                >
                <el-button
                    link
...
<script setup name="ComponentOne">
    ...
    function handleDelete(row) {
        ...
        proxy.$modal
            .confirm('是否确认删除文件分段编号为"' + _ids + '"的数据项？')
            .then(function () {
