            ...
            >
                <template #default="{ node, data }">
                    <span
                        ...
                        @dblclick.stop="handleNodeClick(data, node, 'node')"
                    >
                        <!-- 数据源/层级图标 -->
                        <img
                            v-if="node.level === 1"
                        ...
                        <img
                            v-if="node.level === 2"
                            src="@/assets/system/images/dpp/sr.png"
                            class="node-icon"
                        />
                        <img
                            v-if="node.level === 3"
                            src="@/assets/system/images/dpp/zt.png"
                            class="node-icon"
                        />
                        <!-- label -->
                        ...
                        <!-- 状态图标 -->
                        <el-icon
                            v-if="data.loadSuccess"
                            style="color: #22c55e; margin-left: 6px"
                            class="iconimg"
                            title="加载成功"
                        >
                            <CircleCheckFilled />
                        ...
                        <el-icon
                            v-if="data.loadError"
                            style="color: #facc15; margin-left: 6px; cursor: pointer"
                            class="iconimg"
                            @click.stop="retryLoad(node)"
                            title="加载失败，点击重试"
                        >
                            <WarnTriangleFilled />
                        </el-icon>
...
<script setup>
    ...
    const getDatasourceIcon = (type) => {
        switch (type) {
            ...
            case 'HDFS':
                return new URL('@/assets/system/images/dpp/hdfs.png', import.meta.url).href;
            case 'SHELL':
                return new URL('@/assets/system/images/dpp/SHELL.png', import.meta.url).href;
            case 'Kingbase8':
                return new URL('@/assets/system/images/dpp/kingBase.png', import.meta.url).href;
            case 'SQL_Server':
                return new URL('@/assets/system/images/dpp/SQL_Server.svg', import.meta.url).href;
            case 'SQL_Server2008':
                return new URL('@/assets/system/images/dpp/SQL_Server.svg', import.meta.url).href;
            case 'Doris':
                return new URL('@/assets/system/images/dpp/doris.svg', import.meta.url).href;
            default:
                return null;
        }
    };
