        ...
        <div class="right-content">
            ...
            <div>
                <div class="greeting">
                    ...
                    <div class="entry_greeting">
                      智能体构建平台是未来的考古层，今天存储的每条数据都在书写明天的历史。
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="chrome-wrap">
                    <img src="@/assets/system/images/sso_login/chrome.png" style="height: 20px" />
                    <span style="color: #999999; font-size: 12px; line-height: 0; margin-left: 10px"
                        >为保证最佳浏览效果，请使用</span
                    >
                    ...
                    <span style="color: #999999; font-size: 12px; line-height: 0"
                        >浏览器，点击下载安装</span
                    >
                    <a href="https://ikm.yonyou.com/chromepath/ChromeStandaloneSetup64.exe">
                        <div
                            style="
                                margin-left: 15px;
                                display: flex;
                ...
                <div class="bottom-info">
                    <div class="copy-right">Copyright© 2024 江苏千桐科技有限公司 版权所有</div>
            ...
            <el-form-item label="验证码">
                <div class="wrapper">
                    ...
                    <el-button
                        ...
                        >{{ codeFlag ? `${codeTime}s` : '获取验证码' }}</el-button
                    >
                </div>
            </el-form-item>
    ...
    function getCode() {
        getCodeImg().then((res) => {
            res = {
                ...
                code: 200,
                captchaEnabled: true,
                uuid: 'afa144bff52c495abe1d9a8b78a0da67'
            };
