...
-- 2026.9.11
-- 知识文件类型字典
INSERT IGNORE INTO `system_dict_type` VALUES (103, '文件类型', 'kmc_file_type', '0', '吴同', '2026-07-15 10:20:21', '吴同', '2026-07-15 10:21:24', '知识库文档文件类型');
INSERT IGNORE INTO `system_dict_data` VALUES (187, 1, '非结构化文件', 'text', 'kmc_file_type', NULL, 'primary', 'N', '0', '吴同', '2026-07-15 10:21:39', '吴同', '2026-07-15 10:32:33', NULL);
INSERT IGNORE INTO `system_dict_data` VALUES (188, 2, '半结构化文件', 'json', 'kmc_file_type', NULL, 'info', 'N', '0', '吴同', '2026-07-15 10:21:55', '吴同', '2026-07-15 10:32:40', NULL);

-- 知识库知识文件增加文件类型和 JSON 数据风格
ALTER TABLE `kmc_document`
    ADD COLUMN IF NOT EXISTS `file_type` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文件类型;text：普通文件，json：JSON文件' AFTER `segment_num`,
    ADD COLUMN IF NOT EXISTS `json_style` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'json 风格' AFTER `file_type`;

-- 知识图谱知识文件仅增加文件类型，不保存 JSON 数据风格
ALTER TABLE `kg_knowledge_document`
    ADD COLUMN IF NOT EXISTS `file_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT 'text' COMMENT '文件类型;text：普通文件，json：JSON文件' AFTER `description`;
ALTER TABLE `kg_knowledge_document`
    DROP COLUMN IF EXISTS `json_style`;
UPDATE `kg_knowledge_document` SET `file_type` = 'json' WHERE LOWER(`name`) REGEXP '\\.(json|jsonl)$';

INSERT INTO `kb_bot` VALUES (30, 1001, 'qKnow-Q&A分段', 0, '根据文段生成 Q&A 问答对，结果以 json 格式返回', 1, 1, 0, '吴同', 2, '2026-09-10 18:47:57', '吴同', NULL, '2026-09-10 18:47:57', NULL);
INSERT INTO `kb_flow_edge` VALUES (225, 1001, 30, 'start_1', 'llm_1789037308986_1', NULL, '{\"id\":\"e-start_1-source-llm_1789037308986_1-target-1789037308989-1\",\"type\":\"default\",\"source\":\"start_1\",\"target\":\"llm_1789037308986_1\",\"data\":{},\"events\":{},\"label\":\"\",\"style\":{\"stroke\":\"#999\",\"strokeWidth\":2},\"markerEnd\":{\"type\":\"arrowclosed\",\"width\":12,\"height\":12,\"color\":\"#999\"},\"sourceNode\":{\"id\":\"start_1\",\"type\":\"start\",\"dimensions\":{\"width\":200,\"height\":117},\"computedPosition\":{\"x\":100,\"y\":200,\"z\":0},\"handleBounds\":{\"source\":[{\"type\":\"source\",\"nodeId\":\"start_1\",\"position\":\"right\",\"x\":194,\"y\":53.5,\"width\":10,\"height\":10}],\"target\":[{\"type\":\"target\",\"nodeId\":\"start_1\",\"position\":\"left\",\"x\":-4,\"y\":53.5,\"width\":10,\"height\":10}]},\"selected\":false,\"dragging\":false,\"resizing\":false,\"initialized\":false,\"isParent\":false,\"position\":{\"x\":100,\"y\":200},\"data\":{\"input\":[{\"id\":\"text-1789037293182-1\",\"type\":\"text\",\"name\":\"content\",\"label\":\"文段内容\",\"maxLength\":500,\"defaultValue\":\"\",\"required\":true,\"readonly\":false}],\"config\":{\"label\":\"开始\",\"description\":\"\"},\"output\":[]},\"events\":{}},\"targetNode\":{\"id\":\"llm_1789037308986_1\",\"type\":\"llm\",\"dimensions\":{\"width\":200,\"height\":115},\"computedPosition\":{\"x\":420,\"y\":200,\"z\":0},\"handleBounds\":{\"source\":[{\"type\":\"source\",\"nodeId\":\"llm_1789037308986_1\",\"position\":\"right\",\"x\":194,\"y\":52.5,\"width\":10,\"height\":10}],\"target\":[{\"type\":\"target\",\"nodeId\":\"llm_1789037308986_1\",\"position\":\"left\",\"x\":-4,\"y\":52.5,\"width\":10,\"height\":10}]},\"selected\":false,\"dragging\":false,\"resizing\":false,\"initialized\":false,\"isParent\":false,\"position\":{\"x\":420,\"y\":200},\"data\":{\"input\":[],\"config\":{\"label\":\"LLM\",\"description\":\"\",\"provider\":1,\"model\":\"qwen-max\",\"prompt\":\"根据以下文段，生成以该内容为答案的问题。文段内容如下:\\n{{ start_1.content }}\\n\\n将你的回答以如下的 json 格式输出：{\\\"question\\\":\\\"\\\",\\\"answer\\\":\\\"\\\"}\",\"temperature\":1,\"maxTokens\":4096,\"topP\":1,\"logprobs\":false,\"topLogprobs\":0,\"frequencyPenalty\":0,\"responseFormat\":\"\",\"stopSequences\":\"\",\"memoryEnabled\":false,\"visionEnabled\":false,\"reasoningTagEnabled\":false,\"structuredOutputEnabled\":false,\"retryEnabled\":false,\"errorStrategy\":\"none\"},\"output\":[{\"variableKey\":\"text\",\"variableLabel\":\"text\",\"valueType\":\"string\",\"path\":\"text\"}]},\"events\":{}},\"sourceX\":304,\"sourceY\":258.5,\"targetX\":416,\"targetY\":257.5}', 1, 0, '吴同', 2, '2026-09-10 18:49:08', '吴同', NULL, '2026-09-10 18:49:08', NULL);
INSERT INTO `kb_flow_edge` VALUES (226, 1001, 30, 'llm_1789037308986_1', 'reply_1789037340184_2', NULL, '{\"id\":\"e-llm_1789037308986_1-source-reply_1789037340184_2-target-1789037340187-2\",\"type\":\"default\",\"source\":\"llm_1789037308986_1\",\"target\":\"reply_1789037340184_2\",\"data\":{},\"events\":{},\"label\":\"\",\"style\":{\"stroke\":\"#999\",\"strokeWidth\":2},\"markerEnd\":{\"type\":\"arrowclosed\",\"width\":12,\"height\":12,\"color\":\"#999\"},\"sourceNode\":{\"id\":\"llm_1789037308986_1\",\"type\":\"llm\",\"dimensions\":{\"width\":200,\"height\":115},\"computedPosition\":{\"x\":420,\"y\":200,\"z\":0},\"handleBounds\":{\"source\":[{\"type\":\"source\",\"nodeId\":\"llm_1789037308986_1\",\"position\":\"right\",\"x\":194,\"y\":52.5,\"width\":10,\"height\":10}],\"target\":[{\"type\":\"target\",\"nodeId\":\"llm_1789037308986_1\",\"position\":\"left\",\"x\":-4,\"y\":52.5,\"width\":10,\"height\":10}]},\"selected\":false,\"dragging\":false,\"resizing\":false,\"initialized\":false,\"isParent\":false,\"position\":{\"x\":420,\"y\":200},\"data\":{\"input\":[],\"config\":{\"label\":\"LLM\",\"description\":\"\",\"provider\":1,\"model\":\"qwen-max\",\"prompt\":\"根据以下文段，生成以该内容为答案的问题。文段内容如下:\\n{{ start_1.content }}\\n\\n将你的回答以如下的 json 格式输出：{\\\"question\\\":\\\"\\\",\\\"answer\\\":\\\"\\\"}\",\"temperature\":1,\"maxTokens\":4096,\"topP\":1,\"logprobs\":false,\"topLogprobs\":0,\"frequencyPenalty\":0,\"responseFormat\":\"\",\"stopSequences\":\"\",\"memoryEnabled\":false,\"visionEnabled\":false,\"reasoningTagEnabled\":false,\"structuredOutputEnabled\":false,\"retryEnabled\":false,\"errorStrategy\":\"none\"},\"output\":[{\"variableKey\":\"text\",\"variableLabel\":\"text\",\"valueType\":\"string\",\"path\":\"text\"}]},\"events\":{}},\"targetNode\":{\"id\":\"reply_1789037340184_2\",\"type\":\"reply\",\"dimensions\":{\"width\":200,\"height\":109},\"computedPosition\":{\"x\":720,\"y\":200,\"z\":1000},\"handleBounds\":{\"source\":[{\"type\":\"source\",\"nodeId\":\"reply_1789037340184_2\",\"position\":\"right\",\"x\":194,\"y\":49.5,\"width\":10,\"height\":10}],\"target\":[{\"type\":\"target\",\"nodeId\":\"reply_1789037340184_2\",\"position\":\"left\",\"x\":-4,\"y\":49.5,\"width\":10,\"height\":10}]},\"selected\":true,\"dragging\":false,\"resizing\":false,\"initialized\":false,\"isParent\":false,\"position\":{\"x\":720,\"y\":200},\"data\":{\"input\":[],\"config\":{\"label\":\"输出\",\"description\":\"\",\"content\":\"\"},\"output\":[{\"id\":\"reply-output-1789037343233-1\",\"name\":\"text\",\"sourceNodeId\":\"llm_1789037308986_1\",\"sourceNodeLabel\":\"LLM\",\"sourceNodeType\":\"llm\",\"variableKey\":\"text\",\"variableLabel\":\"text\",\"valueType\":\"string\",\"path\":\"text\"}]},\"events\":{}},\"sourceX\":624,\"sourceY\":257.5,\"targetX\":716,\"targetY\":254.5}', 1, 0, '吴同', 2, '2026-09-10 18:49:08', '吴同', NULL, '2026-09-10 18:49:08', NULL);

INSERT INTO `kb_flow_node` VALUES (338, 1001, 30, 'start_1', '开始', 1, '{\"label\":\"开始\",\"description\":\"\"}', '{\"id\":\"start_1\",\"type\":\"start\",\"dimensions\":{\"width\":200,\"height\":117},\"computedPosition\":{\"x\":100,\"y\":200,\"z\":0},\"handleBounds\":{\"source\":[{\"type\":\"source\",\"nodeId\":\"start_1\",\"position\":\"right\",\"x\":194,\"y\":53.5,\"width\":10,\"height\":10}],\"target\":[{\"type\":\"target\",\"nodeId\":\"start_1\",\"position\":\"left\",\"x\":-4,\"y\":53.5,\"width\":10,\"height\":10}]},\"selected\":false,\"dragging\":false,\"resizing\":false,\"initialized\":false,\"isParent\":false,\"position\":{\"x\":100,\"y\":200},\"data\":{\"input\":[{\"id\":\"text-1789037293182-1\",\"type\":\"text\",\"name\":\"content\",\"label\":\"文段内容\",\"maxLength\":500,\"defaultValue\":\"\",\"required\":true,\"readonly\":false}],\"config\":{\"label\":\"开始\",\"description\":\"\"},\"output\":[]},\"events\":{}}', '[{\"id\":\"text-1789037293182-1\",\"type\":\"text\",\"name\":\"content\",\"label\":\"文段内容\",\"maxLength\":500,\"defaultValue\":\"\",\"required\":true,\"readonly\":false}]', '[]', 1, 0, '吴同', 2, '2026-09-10 18:49:08', '吴同', NULL, '2026-09-10 18:49:08', NULL);
INSERT INTO `kb_flow_node` VALUES (339, 1001, 30, 'llm_1789037308986_1', 'LLM', 2, '{\"label\":\"LLM\",\"description\":\"\",\"provider\":1,\"model\":\"qwen-max\",\"prompt\":\"根据以下文段，生成以该内容为答案的问题。文段内容如下:\\n{{ start_1.content }}\\n\\n将你的回答以如下的 json 格式输出：{\\\"question\\\":\\\"\\\",\\\"answer\\\":\\\"\\\"}\",\"temperature\":1,\"maxTokens\":4096,\"topP\":1,\"logprobs\":false,\"topLogprobs\":0,\"frequencyPenalty\":0,\"responseFormat\":\"\",\"stopSequences\":\"\",\"memoryEnabled\":false,\"visionEnabled\":false,\"reasoningTagEnabled\":false,\"structuredOutputEnabled\":false,\"retryEnabled\":false,\"errorStrategy\":\"none\"}', '{\"id\":\"llm_1789037308986_1\",\"type\":\"llm\",\"dimensions\":{\"width\":200,\"height\":115},\"computedPosition\":{\"x\":420,\"y\":200,\"z\":0},\"handleBounds\":{\"source\":[{\"type\":\"source\",\"nodeId\":\"llm_1789037308986_1\",\"position\":\"right\",\"x\":194,\"y\":52.5,\"width\":10,\"height\":10}],\"target\":[{\"type\":\"target\",\"nodeId\":\"llm_1789037308986_1\",\"position\":\"left\",\"x\":-4,\"y\":52.5,\"width\":10,\"height\":10}]},\"selected\":false,\"dragging\":false,\"resizing\":false,\"initialized\":false,\"isParent\":false,\"position\":{\"x\":420,\"y\":200},\"data\":{\"input\":[],\"config\":{\"label\":\"LLM\",\"description\":\"\",\"provider\":1,\"model\":\"qwen-max\",\"prompt\":\"根据以下文段，生成以该内容为答案的问题。文段内容如下:\\n{{ start_1.content }}\\n\\n将你的回答以如下的 json 格式输出：{\\\"question\\\":\\\"\\\",\\\"answer\\\":\\\"\\\"}\",\"temperature\":1,\"maxTokens\":4096,\"topP\":1,\"logprobs\":false,\"topLogprobs\":0,\"frequencyPenalty\":0,\"responseFormat\":\"\",\"stopSequences\":\"\",\"memoryEnabled\":false,\"visionEnabled\":false,\"reasoningTagEnabled\":false,\"structuredOutputEnabled\":false,\"retryEnabled\":false,\"errorStrategy\":\"none\"},\"output\":[{\"variableKey\":\"text\",\"variableLabel\":\"text\",\"valueType\":\"string\",\"path\":\"text\"}]},\"events\":{}}', '[]', '[{\"variableKey\":\"text\",\"variableLabel\":\"text\",\"valueType\":\"string\",\"path\":\"text\"}]', 1, 0, '吴同', 2, '2026-09-10 18:49:08', '吴同', NULL, '2026-09-10 18:49:08', NULL);
INSERT INTO `kb_flow_node` VALUES (340, 1001, 30, 'reply_1789037340184_2', '输出', 3, '{\"label\":\"输出\",\"description\":\"\",\"content\":\"\"}', '{\"id\":\"reply_1789037340184_2\",\"type\":\"reply\",\"dimensions\":{\"width\":200,\"height\":109},\"computedPosition\":{\"x\":720,\"y\":200,\"z\":1000},\"handleBounds\":{\"source\":[{\"type\":\"source\",\"nodeId\":\"reply_1789037340184_2\",\"position\":\"right\",\"x\":194,\"y\":49.5,\"width\":10,\"height\":10}],\"target\":[{\"type\":\"target\",\"nodeId\":\"reply_1789037340184_2\",\"position\":\"left\",\"x\":-4,\"y\":49.5,\"width\":10,\"height\":10}]},\"selected\":true,\"dragging\":false,\"resizing\":false,\"initialized\":false,\"isParent\":false,\"position\":{\"x\":720,\"y\":200},\"data\":{\"input\":[],\"config\":{\"label\":\"输出\",\"description\":\"\",\"content\":\"\"},\"output\":[{\"id\":\"reply-output-1789037343233-1\",\"name\":\"text\",\"sourceNodeId\":\"llm_1789037308986_1\",\"sourceNodeLabel\":\"LLM\",\"sourceNodeType\":\"llm\",\"variableKey\":\"text\",\"variableLabel\":\"text\",\"valueType\":\"string\",\"path\":\"text\"}]},\"events\":{}}', '[]', '[{\"id\":\"reply-output-1789037343233-1\",\"name\":\"text\",\"sourceNodeId\":\"llm_1789037308986_1\",\"sourceNodeLabel\":\"LLM\",\"sourceNodeType\":\"llm\",\"variableKey\":\"text\",\"variableLabel\":\"text\",\"valueType\":\"string\",\"path\":\"text\"}]', 1, 0, '吴同', 2, '2026-09-10 18:49:08', '吴同', NULL, '2026-09-10 18:49:08', NULL);
