...
INSERT INTO system_dict_type (`dict_id`, `dict_name`, `dict_type`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (32, '知识库启用状态', 'kmc_know_valid', '0', '吴同', '2026-04-21 13:57:05', '', NULL, '知识库启用状态');
INSERT INTO system_dict_data (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (99, 0, '禁用', 'false', 'kmc_know_valid', 'disabled', 'default', 'N', '0', '吴同', '2026-04-21 13:57:05', '', NULL, NULL);
INSERT INTO system_dict_datd (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (173, 1, '启用', 'true', 'kmc_know_valid', 'enabled', 'default', 'N', '0', '吴同', '2026-04-21 13:57:05', 'user001', '2026-05-07 14:14:41', NULL);
INSERT INTO system_dict_type (`dict_id`, `dict_name`, `dict_type`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (30, '文档同步状态', 'document_sync_status', '0', '吴同', '2026-04-21 13:57:05', '', NULL, '文档预览下载埋点类型');
INSERT INTO system_dict_data (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (93, 0, '待解析', '0', 'document_sync_status', NULL, 'info', 'N', '0', '吴同', '2026-04-21 13:57:05', '', NULL, NULL);
INSERT INTO system_dict_data (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (94, 0, '解析中', '1', 'document_sync_status', NULL, 'warning', 'N', '0', '吴同', '2026-04-21 13:57:05', '', NULL, NULL);
INSERT INTO system_dict_data (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (95, 0, '解析成功', '2', 'document_sync_status', NULL, 'success', 'N', '0', '吴同', '2026-04-21 13:57:05', '', NULL, NULL);
INSERT INTO system_dict_data (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (96, 0, '解析失败', '3', 'document_sync_status', NULL, 'danger', 'N', '0', '吴同', '2026-04-21 13:57:05', '', NULL, NULL);
