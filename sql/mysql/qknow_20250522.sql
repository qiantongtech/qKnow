...
insert into system_menu values('111',  '数据监控', '2',   '3', 'druid',      'system/monitor/druid/index',      '', '', 1, 0, 'C', '0', '0', 'monitor:druid:list',      'druid',         '小桐', sysdate(), '', null, '数据监控菜单');
insert into system_menu values('112',  '服务监控', '2',   '4', 'server',     'system/monitor/server/index',     '', '', 1, 0, 'C', '0', '0', 'monitor:server:list',     'server',        '小桐', sysdate(), '', null, '服务监控菜单');
insert into system_menu values('113',  '缓存监控', '2',   '5', 'cache',      'system/monitor/cache/index',      '', '', 1, 0, 'C', '0', '0', 'monitor:cache:list',      'redis',         '小桐', sysdate(), '', null, '缓存监控菜单');
insert into system_menu values('114',  '缓存列表', '2',   '6', 'cacheList',  'system/monitor/cache/list',       '', '', 1, 0, 'C', '0', '0', 'monitor:cache:list',      'redis-list',    '小桐', sysdate(), '', null, '缓存列表菜单');
insert into system_menu values('115',  '表单构建', '3',   '1', 'build',      'system/tool/build/index',         '', '', 1, 0, 'C', '0', '0', 'tool:build:list',         'build',         '小桐', sysdate(), '', null, '表单构建菜单');
insert into system_menu values('116',  '代码生成', '3',   '2', 'gen',        'system/tool/gen/index',           '', '', 1, 0, 'C', '0', '0', 'tool:gen:list',           'code',          '小桐', sysdate(), '', null, '代码生成菜单');
insert into system_menu values('117',  '系统接口', '3',   '3', 'swagger',    'system/tool/swagger/index',       '', '', 1, 0, 'C', '0', '0', 'tool:swagger:list',       'swagger',       '小桐', sysdate(), '', null, '系统接口菜单');
-- 三级菜单
...
-- 代码生成按钮
insert into system_menu values('1055', '生成查询', '116', '1', '#', '', '', '', 1, 0, 'F', '0', '0', 'tool:gen:query',             '#', '小桐', sysdate(), '', null, '');
insert into system_menu values('1056', '生成修改', '116', '2', '#', '', '', '', 1, 0, 'F', '0', '0', 'tool:gen:edit',              '#', '小桐', sysdate(), '', null, '');
insert into system_menu values('1057', '生成删除', '116', '3', '#', '', '', '', 1, 0, 'F', '0', '0', 'tool:gen:remove',            '#', '小桐', sysdate(), '', null, '');
insert into system_menu values('1058', '导入代码', '116', '4', '#', '', '', '', 1, 0, 'F', '0', '0', 'tool:gen:import',            '#', '小桐', sysdate(), '', null, '');
insert into system_menu values('1059', '预览代码', '116', '5', '#', '', '', '', 1, 0, 'F', '0', '0', 'tool:gen:preview',           '#', '小桐', sysdate(), '', null, '');
insert into system_menu values('1060', '生成代码', '116', '6', '#', '', '', '', 1, 0, 'F', '0', '0', 'tool:gen:code',              '#', '小桐', sysdate(), '', null, '');
